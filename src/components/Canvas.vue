...
export default {
  ...
  data() {
    return {
      class_names: ["airplane","ambulance","angel","ant","anvil","apple","arm","axe","backpack","banana","bandage","barn","baseball","basket","basketball","bat","bathtub","beach","bear","beard","bed","bee","belt","bench","bicycle","binoculars","bird","blueberry","book","boomerang","bracelet","brain","bread","bridge","broom","bucket","bulldozer","bus","bush","butterfly","cactus","cake","calculator","calendar","camel","camera","camouflage","campfire","candle","cannon","canoe","car","carrot","castle","cat","cello","chair","church","circle","clarinet","clock","cloud","compass","computer","cookie","cooler","couch","cow","crab","crocodile","crown","cup","diamond","dishwasher","dog","dolphin","donut","door","dragon","dresser","drill","drums","duck","ear","elbow","elephant","envelope","eraser","eye","eyeglasses","face","fan","feather","fence","finger","fireplace","fish","flashlight","flower","foot","fork","frog","garden","giraffe","goatee","grapes","grass","guitar","hamburger","hammer","hand","harp","hat","headphones","hedgehog","helicopter","helmet","horse","hospital","hourglass","house","hurricane","jacket","jail","kangaroo","key","keyboard","knee","knife","ladder","lantern","laptop","leaf","leg","lighter","lighthouse","lightning","line","lion","lipstick","lobster","lollipop","mailbox","map","marker","matches","megaphone","mermaid","microphone","monkey","moon","mosquito","motorbike","mountain","mouse","moustache","mouth","mug","mushroom","nail","necklace","nose","ocean","octopus","onion","oven","owl","paintbrush","panda","pants","parachute","parrot","passport","peanut","pear","peas","pencil","penguin","piano","pig","pillow","pineapple","pizza","pond","pool","postcard","potato","purse","rabbit","raccoon","radio","rain","rainbow","rhinoceros","rifle","river","rollerskates","sailboat","sandwich","saw","saxophone","scissors","scorpion","screwdriver","shark","sheep","shoe","shorts","shovel","sink","skateboard","skull","skyscraper","snail","snake","snorkel","snowflake","snowman","sock","spider","spoon","square","squiggle","squirrel","stairs","star","steak","stereo","stitches","stove","strawberry","submarine","suitcase","sun","swan","sweater","sword","syringe","table","teapot","telephone","television","tent","tiger","toe","toilet","tooth","toothbrush","toothpaste","tornado","tractor","train","tree","triangle","truck","trumpet","t-shirt","umbrella","underwear","van","vase","violin","watermelon","whale","wheel","windmill","wristwatch","yoga","zebra"],
      predicted_word: "",
      model: null,
      firebase_movieDB: "",
      canvasCtx: null,
  ...
  async mounted() {
    ...
    this.model = await tf.loadLayersModel(
      "https://storage.googleapis.com/guessing_movie_269/model.json"
    );
